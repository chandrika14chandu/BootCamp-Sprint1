...
public class Reviews 
{
	...
	@NotNull(message = "CustomerId is Mandatory field, please provide CustomerId")
	...
	@NotNull(message = "Headline is Mandatory field, please provide Headline")
	@Size(min = 5, max = 128, message = "Headline should be between 20 to 120 characters")
	private String headline;

	@Column(name = "Review_Comment", length = 300)
	@NotEmpty(message = "comment is Mandatory field, please provide comment")
	@Size(min = 10, max = 300, message = "Comment should be between 100 to 300 characters")
