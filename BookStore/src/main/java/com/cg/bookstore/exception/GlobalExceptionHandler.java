...
class GlobalExceptionHandler
{
	...
	public ResponseEntity<ErrorInfo> handleException(ReviewIsUnAvailableException exception,
	...
	public ResponseEntity<ErrorInfo> handleException(ReviewIdDoesNotExistException exception,
		   HttpServletRequest request) 
	{
	  String message = exception.getMessage();
	  String uri = request.getRequestURI();
